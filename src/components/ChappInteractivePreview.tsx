...
const ChappInteractivePreview = () => {
  ...
  const tabs = [
    { 
      id: 'dashboard', 
      name: t('preview.tab.dashboard'), 
      icon: BarChart3,
      description: t('preview.tab.dashboard.desc')
    },
    { 
      id: 'webapp', 
      name: t('preview.tab.webapp'), 
      icon: Monitor,
      description: t('preview.tab.webapp.desc')
    },
    { 
      id: 'mobile', 
      name: t('preview.tab.mobile'), 
      icon: Smartphone,
      description: t('preview.tab.mobile.desc')
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="card-glass-dark p-8 animate-on-scroll">
            <div className="mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              >
                <Eye size={16} />
                <span>{isPlaying ? t('preview.play.active') : t('preview.play.idle')}</span>
              </button>
            </div>
